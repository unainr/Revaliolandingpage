...
const About = () => {
  ...
  return (
    ...
    >
      {/* Decorative elements */}
      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[#5f34f8]/30 to-transparent"></div>
      <div className="absolute -top-40 -right-40 w-80 h-80 bg-[#5f34f8]/5 rounded-full blur-3xl"></div>
      <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-[#5f34f8]/5 rounded-full blur-3xl"></div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-10">
            ...
            >
              <div className="inline-block px-4 py-1 bg-[#5f34f8]/10 rounded-full text-[#5f34f8] font-medium text-sm mb-2 border border-[#5f34f8]/20">
                About Us
              </div>
              <h2 className="text-4xl md:text-5xl font-bold text-foreground">
                Trusted by <span className="bg-gradient-to-r from-[#5f34f8] to-[#9d71fd] bg-clip-text text-transparent">Industry Leaders</span>
              </h2>
            ...
            <div className={`transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <Button 
                size="lg" 
                className="group bg-[#5f34f8] hover:bg-[#5f34f8]/90 text-white px-8 py-6 h-auto rounded-xl shadow-lg shadow-[#5f34f8]/20 hover:shadow-xl hover:shadow-[#5f34f8]/30 transition-all duration-300"
              >
                Learn More
          ...
          >
            {/* Main card */}
            <div className="aspect-square bg-gradient-to-br from-[#5f34f8]/20 to-[#9d71fd]/10 rounded-2xl p-8 relative overflow-hidden">
              ...
              <div className="w-full h-full bg-white dark:bg-gray-800 rounded-xl shadow-2xl flex items-center justify-center relative z-10 overflow-hidden">
                ...
                <div className="absolute top-0 right-0 w-24 h-24 bg-[#5f34f8]/5 rounded-bl-full"></div>
                <div className="absolute bottom-0 left-0 w-24 h-24 bg-[#5f34f8]/5 rounded-tr-full"></div>
                
                <div className="text-center space-y-6 p-8 max-w-xs">
                  <div className="relative">
                    <div className="w-20 h-20 bg-gradient-to-br from-[#5f34f8] to-[#9d71fd] rounded-2xl flex items-center justify-center mx-auto rotate-12 shadow-lg">
            ...
            <div className="absolute -top-6 -left-6 w-12 h-12 bg-[#5f34f8]/10 rounded-lg rotate-12 border border-[#5f34f8]/30"></div>
            <div className="absolute -bottom-6 -right-6 w-12 h-12 bg-[#9d71fd]/10 rounded-full border border-[#9d71fd]/30"></div>
          </div>
        </div>
        
        {/* Stats row */}
        <div 
          className={`mt-24 grid grid-cols-2 md:grid-cols-4 gap-8 transition-all duration-1000 delay-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
        >
          {[
            ...
            <div key={index} className="text-center">
              <div className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-[#5f34f8] to-[#9d71fd] bg-clip-text text-transparent">
                {stat.value}
              </div>
